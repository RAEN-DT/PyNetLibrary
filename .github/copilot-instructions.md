...
This agent works alongside the other coding agents in this repository (Claude Code, Codex). All of them share `AGENTS.md`.

## Precedence

- `AGENTS.md` (repository root) is the canonical authority for project-specific AI guidance. Read it before analysing, editing, or running anything.
- If there is any conflict between this file and `AGENTS.md`, `AGENTS.md` takes precedence.
- Do not create a second source of truth for PyNET, Navisworks, or project workflow rules that already exist in `AGENTS.md`.
...
- Reuse the project context and workflow already defined in `AGENTS.md` instead of redefining it.

## Boundaries

- Keep project rules, domain workflow, execution constraints, and approval policy in `AGENTS.md`.
